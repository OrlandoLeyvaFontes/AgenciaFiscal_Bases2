...
public class Clientes implements Serializable {
    ...
    public Clientes(String nombreCompleto, String rfc, LocalDate fechaNacimiento) {
        this.rfc = rfc;
        this.nombreCompleto = nombreCompleto;
        this.fechaNacimiento = fechaNacimiento;
    }
    
    public Clientes(String nombreCompleto, String rfc, LocalDate fechaNacimiento, String telefono) {
        this.rfc = rfc;
        this.nombreCompleto = nombreCompleto;
        this.fechaNacimiento = fechaNacimiento;
